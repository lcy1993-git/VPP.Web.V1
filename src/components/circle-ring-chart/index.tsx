...
const CircleRingChart = (props: PropsType) => {
  ...
  return <div style={{ width: breadth, height: '100%' }} className={styles.flex_center}>
    ...
    >
      {
        children ? children : <div className={styles.circleTitle}>
          <span className={styles.titleH1}>{textName}</span>
          <span className={styles.titleValue} style={{fontSize:size+'px'}}>{value}</span>
